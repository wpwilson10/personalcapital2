...
def test_parse_investment_performance() -> None:
    ...
    assert by_account[305886794]["performance"] == 72.23
    assert by_account[1511350375]["performance"] == 0.08
...
def test_parse_benchmark_performance() -> None:
    ...
    assert by_bench["^PC_US_STOCKS"]["performance"] == 554.0
    assert by_bench["^PC_INTL_BONDS"]["performance"] == -9.36
